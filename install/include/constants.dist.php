...
// APIs URLS
define('API_NEWLIST_EXEC', '/usr/sbin/newlist --urlhost=%urlhost --emailhost=%emailhost --automate %unixname %owneremail %adminpass');
define('API_RMLIST_EXEC', '/usr/sbin/rmlist --archives %unixname');
...
// Mailman Hosting Services Details
define('API_SERVICE_API_HOST', '');
define('API_SERVICE_API_IPV4', '');
define('API_SERVICE_API_IPV6', '');
define('API_SERVICE_API_NEWS', '');

// Master Peering Hostname
define('API_PRIMARY_SYSOP_UID', 1);

// Paths on System
define('API_PGPKEYS_PATH', '');
